-- Fix: Add short_term_available field to caretaker_profiles
...
-- Drop and recreate the caretaker_search_view to include short_term_available
...
AND column_name = 'short_term_available';